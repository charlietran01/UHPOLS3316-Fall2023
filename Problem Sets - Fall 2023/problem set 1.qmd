...
object_mean <- object_sum/length(my_vector) 
object_mean
```
...
I want to use methods of exploratory data analysis to find any insights on how/which variables affect housing prices.
